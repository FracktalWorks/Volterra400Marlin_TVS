...
#if TEMP_SENSOR_FILBOX > 0
  #define THERMISTORFILBOX TEMP_SENSOR_FILBOX
  #define HEATER_FILBOX_USES_THERMISTOR
#endif
...
#define HAS_TEMP_SENSOR (HAS_TEMP_HOTEND || HAS_HEATED_BED || HAS_TEMP_CHAMBER || HAS_TEMP_FILBOX)
